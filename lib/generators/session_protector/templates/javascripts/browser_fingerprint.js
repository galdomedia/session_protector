(function($) {
  $(document).ready(function() {
    ...
    var cookieName = '_browser_fingerprint';
    var fingerprint = getCookie(cookieName);
    var nullFingerprint = "5e543256c480ac577d30f76f9120eb74";
    if(fingerprint == null || fingerprint == nullFingerprint) {
      fingerprint = fetch_client_whorls();
      createCookie(cookieName, md5(fingerprint), null);
    }
  });
  ...
  function getCookie(name) {
    if (document.cookie.length > 0) {
      ...
      if (start != -1) {
        ...
        var rawCookie = document.cookie.substring(start, end);
        return unescape(rawCookie);
      }
    }
  }
